    ...
    return (
        ...
        >
            <div className="max-w-[1920px] mx-auto px-6 lg:px-16">
                <div className="flex items-center justify-center h-20 relative py-2">
                    {/* Logo - Left */}
                    <motion.a
                        href="#home"
                        className="absolute left-6 lg:left-16 flex items-center gap-3 group"
                    ...
                    >
                        <motion.div 
                            className="w-14 h-14 rounded-full bg-[#FF6B35] flex items-center justify-center overflow-hidden shadow-lg shadow-orange-500/30 relative border-2 border-[#FF6B35] p-0.5"
                            whileHover={{ 
                    ...
                    <div className="hidden lg:block absolute right-6 lg:right-16">
                        <motion.a
                            href="#contact"
                            className="btn-primary text-[13px] uppercase tracking-[1.5px] px-8 py-3.5 rounded-lg relative overflow-hidden group"
                            initial={{ opacity: 0, x: 50 }}
                            animate={{ opacity: 1, x: 0 }}
                    ...
                    <div className="lg:hidden flex items-center gap-4">
                        <motion.a
                            href="#contact"
                            className="btn-primary text-[13px] uppercase tracking-[1.5px] px-4 py-2 text-sm hidden sm:block"
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                        >
                            Book a call
